...
def polarisation(st, plot, name='Pol_plot'):
    ...
    tstart = utct('2019-07-16T20:11:01.494538Z')
    tend = utct('2019-07-16T21:11:01.469538Z')
    
    timing_P = utct('2019-07-16T20:11:19')
    timing_S = utct('2019-07-16T20:11:32')
    timing_noise = [utct('2019-07-16T20:10:01'), utct('2019-07-16T20:11:15')]
